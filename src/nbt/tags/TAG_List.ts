  ...
  static fromBuffer(bytes: Buffer): TAG_List {
    ...
    for (let i = 0; i < res.data; i++) {
      switch (type) {
        ...
        //SHORT
        case 2: {
          const res1 = readShort(bytes, TAG_Tag._index);
        ...
        //INT
        case 3: {
          const res2 = readInt(bytes, TAG_Tag._index);
        ...
        //LONG
        case 4: {
          const res3 = readLong(bytes, TAG_Tag._index);
        ...
        //FLOAT
        case 5: {
          const res4 = readFloat(bytes, TAG_Tag._index);
        ...
        //DOUBLE
        case 6: {
          const res5 = readDouble(bytes, TAG_Tag._index);
        ...
        //STRING
        case 8: {
          const res6 = readString(bytes, TAG_Tag._index);
